...
- 创建数据库（根据个人需求定制创建），数据库编码为UTF-8
- 执行db/mysql.sql文件，初始化数据
- 修改application-dev.yml，更新MySQL账号和密码
- Eclipse、IDEA运行okayApplication.java，则可启动项目
- Swagger文档路径：http://localhost:8080/项目路径/swagger/index.html
- Swagger注解路径：http://localhost:8080/项目路径/swagger-ui.html
 ...
 **项目演示**
- 演示地址：http://demo.open.okay.io/okay-fast
- 账号密码：admin/admin
<br> 
...
待解决问题：
1.批量生成代码在chome浏览器无法使用，经测试在firefox浏览器可以完美运行。